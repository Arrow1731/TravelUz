...
export default function AIChat({ teachers }: Props) {
  ...
  return (
    <div className="flex flex-col space-y-4">
      <div className="max-h-64 overflow-y-auto p-4 bg-white rounded-lg border border-gray-200 flex flex-col gap-2">
        {messages.length === 0 && (
          <p className="text-gray-400 text-sm">Ask a question to the AI...</p>
        )}
