          ...
          <Card className="shadow-xl bg-white/90">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                ...
                {userType === "StudentGuide" && t.StdentGuide}
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <RadioGroup value={userType} onValueChange={(v: any) => setUserType(v)}>
                  ...
                  {/* Student GUiDE */}
                  <div className="flex items-center space-x-2 p-3 border rounded-lg">
                    <RadioGroupItem id="StudentGuide" value="StudentGuide" />
                    <Label htmlFor="guide" className="flex items-center">
                      <UserCheck className="w-4 h-4 mr-2 text-orange-600" />
                      {t.StudentGuide}
                    </Label>
              ...
              {(userType === "guide" || userType === "StudentGuide") && (
                <div className="space-y-4">
